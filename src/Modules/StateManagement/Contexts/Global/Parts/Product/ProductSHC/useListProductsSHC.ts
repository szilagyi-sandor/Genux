...
export const useListProductsSHC = ({
  productStores: {
    list: [, listDispatch],
  },
}: GlobalStores): ProductSH["listProducts"] => {
  // This is an advanced example, where we are letting this function to be called multiple times.
  // The right usage would be simply cancel and return when the call is not the last one. In that case
